...
class MESController extends Controller
{
    ...
    public function dailyOutput($date = null) {
        ...
        foreach ($shifts as $shift) {
            ...
            $sql = "SELECT '" . $shift->details->descr . "' AS SHIFT, D.LINDESC AS PRODLINE, PRODTYPE, LOCNCODE, COUNT(A.SERIALNO) AS 'Total' ";
