                ...
                <div class="card-body">
                        <div class="jumbotron text-center">
                            <div class="row">
                                ...
                                <div class="col-md-5">  
                                    {{Form::select('station', array('MA1AT&BPullTest' => 'MA1A T&B PullTest', 'MA1BT&BPullTest' => 'MA1B T&B PullTest', 'MatrixReworkPullTest' => 'Matrix ReworkPullTest','BBtoBBPullTest ' => 'BB to BB Pull Test '),'Select Station',['class' => 'form-control','placeholder' => 'Select Station'])}}
                    ...
                    &emsp; {{Form::submit('Submit',['class'=> 'btn btn-primary'])}}&emsp; <a href="/matrixpulltest" class="btn btn-danger">Cancel</a>
                    {!! Form::close() !!}
                @endsection
