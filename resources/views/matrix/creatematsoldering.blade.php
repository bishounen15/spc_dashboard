...
@section('content')
    ...
    <div class="container" style="width:120%">  
        ...
        <div class="card">
            <h5 class="card-header">Matrix Soldering Temp Data Inputs</h5>
        <div class="card-body">
                        ...
                        <h5 class="card-header">Top 1</h5>
                            ...
                            <div class="jumbotron text-center">
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('site1', 'Temp 1:')}} </div>
                                <div class="col-md-3"> {{Form::text('pulltest1','', ['class' => 'form-control','placeholder' => 'Temp1', 'id' => 'pulltest1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('pulltest1') }}</small> </div> 
                            ...
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('site2', 'Temp 2:')}} </div>
                                <div class="col-md-3"> {{Form::text('pulltest2','', ['class' => 'form-control','placeholder' => 'Temp2', 'id' => 'pulltest2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('pulltest2') }}</small> </div>     
                            </div></br> 

                            <div class="row">
                                <div class="col-md-1"> {{Form::label('site3', 'Temp 3:')}} </div>
                                <div class="col-md-3"> {{Form::text('pulltest3','', ['class' => 'form-control','placeholder' => 'Temp3', 'id' => 'pulltest3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('pulltest3') }}</small> </div>     
                            </div></br>
                        </div>
                    </div>
                </div>
                        ...
                        <h5 class="card-header">Top 2</h5>
                            ...
                            <div class="jumbotron text-center">
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('twosite1', 'Temp 1:')}} </div>
                                <div class="col-md-3"> {{Form::text('twopulltest1','', ['class' => 'form-control','placeholder' => 'Temp1', 'id' => 'twopulltest1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('twopulltest1') }}</small> </div> 
                            ...
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('twosite2', 'Temp 2:')}} </div>
                                <div class="col-md-3"> {{Form::text('twopulltest2','', ['class' => 'form-control','placeholder' => 'Temp2', 'id' => 'twopulltest2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('twopulltest2') }}</small> </div>     
                            </div></br> 

                            <div class="row">
                                <div class="col-md-1"> {{Form::label('twosite3', 'Temp 3:')}} </div>
                                <div class="col-md-3"> {{Form::text('twopulltest3','', ['class' => 'form-control','placeholder' => 'Temp3', 'id' => 'twopulltest3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('twopulltest3') }}</small> </div>     
                            </div></br>
                        </div>
                    </div>
                </div>
                ...
                <div class="card top">
                    <h5 class="card-header">Top</h5>
                        ...
                        <div class="jumbotron text-center">
                        <div class="row">
                            <div class="col-md-1"> {{Form::label('topsite1', 'Temp 1:')}} </div>
                            <div class="col-md-3"> {{Form::text('toppulltest1','', ['class' => 'form-control','placeholder' => 'Temp1', 'id' => 'toppulltest1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest1') }}</small> </div> 
                        ...
                        <div class="row">
                            <div class="col-md-1"> {{Form::label('botsite2', 'Temp 2:')}} </div>
                            <div class="col-md-3"> {{Form::text('toppulltest2','', ['class' => 'form-control','placeholder' => 'Temp2', 'id' => 'toppulltest2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest2') }}</small> </div>     
                        </div></br> 

                        <div class="row">
                            <div class="col-md-1"> {{Form::label('botsite3', 'Temp 3:')}} </div>
                            <div class="col-md-3"> {{Form::text('toppulltest3','', ['class' => 'form-control','placeholder' => 'Temp3', 'id' => 'toppulltest3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest3') }}</small> </div>     
                        </div></br>
                    </div>  
                </div>
            </div>
                        <div class="card bottomBus">
                            <h5 class="card-header">Bottom</h5>
                                ...
                                <div class="jumbotron text-center">
                                <div class="row">
                                    <div class="col-md-1"> {{Form::label('bussite1', 'Temp 1:')}} </div>
                                    <div class="col-md-3"> {{Form::text('buspulltest1','', ['class' => 'form-control','placeholder' => 'Temp1', 'id' => 'buspulltest1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest1') }}</small> </div> 
                                    <div class="col-md-1"> {{Form::label('botaverage', 'Average:')}} </div>
                                ...
                                <div class="row">
                                    <div class="col-md-1"> {{Form::label('botsite2', 'Temp 2:')}} </div>
                                    <div class="col-md-3"> {{Form::text('buspulltest2','', ['class' => 'form-control','placeholder' => 'Temp2', 'id' => 'buspulltest2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest2') }}</small> </div>     
                                </div></br> 
    
                                <div class="row">
                                    <div class="col-md-1"> {{Form::label('botsite3', 'Temp 3:')}} </div>
                                    <div class="col-md-3"> {{Form::text('buspulltest3','', ['class' => 'form-control','placeholder' => 'Temp3', 'id' => 'buspulltest3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest3') }}</small> </div>     
                                </div></br>
                            </div>  
                        </div>
                    </div>
                    ...
                    <div class="card bottom">
                        <h5 class="card-header">Bottom</h5>
                            ...
                            <div class="jumbotron text-center">
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('botsite1', 'Temp 1:')}} </div>
                                <div class="col-md-3"> {{Form::text('botpulltest1','', ['class' => 'form-control','placeholder' => 'Temp1', 'id' => 'botpulltest1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest1') }}</small> </div> 
                                <div class="col-md-1"> {{Form::label('botaverage', 'Average:')}} </div>
                            ...
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('botsite2', 'Temp 2:')}} </div>
                                <div class="col-md-3"> {{Form::text('botpulltest2','', ['class' => 'form-control','placeholder' => 'Temp2', 'id' => 'botpulltest2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest2') }}</small> </div>     
                            </div></br> 

                            <div class="row">
                                <div class="col-md-1"> {{Form::label('botsite3', 'Temp 3:')}} </div>
                                <div class="col-md-3"> {{Form::text('botpulltest3','', ['class' => 'form-control','placeholder' => 'Temp3', 'id' => 'botpulltest3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botpulltest3') }}</small> </div>     
                            </div></br>
                        </div>  
                    </div>
                </div>
