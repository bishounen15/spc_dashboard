                ...
                <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">  {{Form::text('temp1','', ['class' => 'temp1 form-control','placeholder' => 'Temp 1', 'id' => 'temp1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('temp1') }}</small>
                                </div> 
                                <div class="col-md-1">  {{Form::label('average', 'Average:')}} </div>
                                <div class="col-md-5">  {{Form::text('average','', ['class' => ' average form-control','placeholder' => 'Average', 'id' => 'average', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('average') }}</small>
                                </div>     
                            </div></br> 
                            <div class="row">
                            ...
                            <div class="card">
                                ...
                                <div class="jumbotron text-center">
                                <div class="row">
                                <div class="col-md-1">  {{Form::label('bottemp1', 'Temp 1:')}} </div>
                                <div class="col-md-5">  {{Form::text('bottemp1','', ['class' => 'temp1 form-control','placeholder' => 'Temp 1', 'id' => 'bottemp1', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('bottemp1') }}</small> </div> 
                                <div class="col-md-1">  {{Form::label('botaverage', 'Average:')}} </div>
                                <div class="col-md-5">  {{Form::text('botaverage','', ['class' => ' average form-control','placeholder' => 'Average', 'id' => 'botaverage', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('botaverage') }}</small> </div>     
                            </div></br> 
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('bottemp2', 'Temp 2:')}} </div>
                                <div class="col-md-5"> {{Form::text('bottemp2','', ['class' => 'temp2 form-control','placeholder' => 'Temp 2', 'id' => 'bottemp2', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('bottemp2') }}</small> </div>  
                            </div></br> 
                            <div class="row">
                                <div class="col-md-1"> {{Form::label('bottemp3', 'Temp 3:')}} </div>
                                <div class="col-md-5"> {{Form::text('bottemp3','', ['class' => 'temp3 form-control','placeholder' => 'Temp 3', 'id' => 'bottemp3', 'onkeyup' => 'calc()'])}} <small class="form-text text-danger">{{ $errors->first('bottemp3') }}</small> </div>      
                            </div></br>
                        </div>
                                ...
                                @push('jscript')
                                    <script>
                                        function calc(){
                                            ...
                                            parseFloat(document.getElementById('bottemp1').value) + 
                                            parseFloat(document.getElementById('bottemp2').value) + 
                                            parseFloat(document.getElementById('bottemp3').value)) / 3);
                                            }           
                                    </script>
                                @endpush    
                                @endsection 